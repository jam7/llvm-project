...
namespace llvm {
  ...
  public:
    ...
    bool is4096BitVector() const {
      return (SimpleTy == MVT::v128i32 || SimpleTy == MVT::v64i64 ||
              SimpleTy == MVT::v128f32 || SimpleTy == MVT::v64f64);
    }

    /// Return true if this is a 8192-bit vector type.
    bool is8192BitVector() const {
      return (SimpleTy == MVT::v256i32 || SimpleTy == MVT::v128i64 ||
              SimpleTy == MVT::v256f32 || SimpleTy == MVT::v128f64);
    }

    /// Return true if this is a 16384 vector type.
    bool is16384BitVector() const {
      return (SimpleTy == MVT::v512i32 || SimpleTy == MVT::v256i64 ||
              SimpleTy == MVT::v512f32 || SimpleTy == MVT::v256f64);
    }
